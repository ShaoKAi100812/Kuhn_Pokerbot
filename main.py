...
def __main__():
    ...
    if args.server_local is True:
        ...
        server_address = 'eccd6a3b-98cb-4660-b04b-90d8d2c2d155.pub.instances.scw.cloud:50051'
    elif args.server is not None:
        server_address = args.server        # correct version
    ...
    if args.rename:
        ...
        client.play(args.play, args.cards, lambda: PokerAgent(parser.parse_args().cards))
